...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const hasData = profile && (profile.name || profile.bio || (profile.bioFiles && profile.bioFiles.length > 0) || (profile.links && profile.links.length > 0) || profile.rules || (profile.rulesFiles && profile.rulesFiles.length > 0));
